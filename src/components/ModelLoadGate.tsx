      ...
      >
        {status === "needs-consent" ? (
          <>
            ...
            <h2 id="load-title">Download AI model?</h2>
            <p>
              This app downloads a 250MB AI model and runs it from your device's
              web browser..
        ...
        {status === "error" ? (
          <>
            ...
            <p>
              {error ?? "Something went wrong while preparing local inference."}
            </p>
            <div className="load-actions">
              <button
                type="button"
